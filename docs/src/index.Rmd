...
simulations](simulate). I simulated from two different models, the [**random
degree**](simulate/src/rand-degree.R) model, which allows
each respondent's degree (the total number of people they know) to vary, and
the [**barrier effects**](simulate/src/barrier-fx.R) model,
...
in [`fit-models/src`](fit-models/src).
...
See [assess-fit/output](assess-fit/output) for all of the
